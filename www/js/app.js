...
var app = new Framework7({
                         ...
                         id: 'com.classementparissportifs.mobileapp', // App bundle ID
                         ...
                         app.request.json(
                                          ...
                                          '<a href="/bookmaker/' + bookMeta["id-fiche-bookmaker"] + '" class="link panel-close" data-bookmker="' + bookItem.term_id + '">' +
                         ...
                         app.request.json(app.data.mpsJsonBase + 'quizz/form', { quiz: 1 },
                                          ...
                                          '<button type="submit" name="SendQuiz" class="btn-shadow open-preloader" value="Valider">Valider</button>' +
                                          '</div>';
...
function onDeviceReady() {
    ...
    startPub(
             "https://paris-sportifs-top10.fr/wp-admin/admin-ajax.php?action=param_api_url_action&param=2",
             "https://paris-sportifs-top10.fr/wp-admin/admin-ajax.php?action=param_api_url_action&param=2",
             "https://paris-sportifs-top10.fr/wp-admin/admin-ajax.php?action=param_api_url_action&param=3"
             );
